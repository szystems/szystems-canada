...
| 5 | Actualizar sitemap.xml | ⬜ | Quitar URLs de páginas eliminadas |
| 6 | Actualizar robots.txt | ⬜ | Revisar reglas |
...
| 5 | Floating contact button: agregar link al portal | ⬜ | Botón flotante actual (email, phone, LinkedIn, WhatsApp) |
| 6 | Excepciones: Mantenimiento, SEO, Hosting → siguen a contact form | ⬜ | Estos servicios no pasan por intake |

#### W5: Navegación con Portal
| # | Tarea | Estado | Notas |
|---|-------|--------|-------|
| 1 | Agregar "Client Portal" al nav EN con dropdown | ⬜ | Start a Project → intake, Client Login → portal |
| 2 | Agregar "Portal de Clientes" al nav ES con dropdown | ⬜ | |
| 3 | Botón destacado (pill/outline) diferenciado | ⬜ | |
...
| 2 | Versión ES en index-es.html | ⬜ | |
| 3 | Iconos/visual del portal | ⬜ | |

#### W7: Simplificar Contact Form
| # | Tarea | Estado | Notas |
|---|-------|--------|-------|
| 1 | Reducir campos: nombre, email, mensaje, razón | ⬜ | Eliminar: service, budget, timeline, referral |
| 2 | Banner prominente: "¿Quieres un proyecto? Usa el portal" | ⬜ | Link a intake arriba del form |
...
| 2 | About: Victoria como sede histórica, no limitación | ⬜ | |
| 3 | Footer: quitar dirección física, dejar "Canada" | ⬜ | |
| 4 | Schema.org: LocalBusiness → Organization, areaServed global | ⬜ | |
| 5 | Eliminar teléfono Guatemala del sitio Canadá | ⬜ | |

#### W6: Trust Signals
| # | Tarea | Estado | Notas |
|---|-------|--------|-------|
| 1 | Badges: Canadian Registered, Secure Portal, 4+ Countries, Bilingual | ⬜ | |
| 2 | Sección en homepage o about | ⬜ | |
| 3 | Icono candado junto a links del portal | ⬜ | |
...
| # | Tarea | Estado | Notas |
|---|-------|--------|-------|
| 1 | landing-services: form → redirect a intake con UTM | ⬜ | |
...
| 4 | Canonical URLs | ⬜ | |
| 5 | Sitemap.xml final (sin páginas Guatemala) | ⬜ | |
